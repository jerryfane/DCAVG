...
def main(btc_to_buy,buy_eur_per_day):
    ...
    save_load_info(transactTime, bitcoin_price_usd, bitcoin_price_eur, buy_eur_per_day / bitcoin_price_eur, buy_eur_per_day / bitcoin_price_eur*bitcoin_price_usd)
    ...
    if btc_to_buy_value < 10:
        ...
        save_buy_info(buy_info, bitcoin_price_eur)
